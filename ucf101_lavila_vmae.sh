...
#SBATCH -w moana-y5
#SBATCH -o /data/jong980812/project/Video-CBM/results/ucf101_internvid_vmae_ucf_finetune/ucf_sub/%A-%x.out
#SBATCH -e /data/jong980812/project/Video-CBM/results/ucf101_internvid_vmae_ucf_finetune/ucf_sub/%A-%x.err

OUTPUT_DIR='/data/jong980812/project/Video-CBM/results/ucf101_internvid_vmae_ucf_finetune/ucf_sub'


python /data/jong980812/project/Video-CBM/train_video_cbm.py \
--data_set UCF101 \
--nb_classes 101 \
--concept_set /data/jong980812/project/Video-CBM/data/concept_sets/ucf101_subactions.txt \
--batch_size 48 \

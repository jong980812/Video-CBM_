...
def train_one_epoch(model: torch.nn.Module, data_loader: Iterable, optimizer: torch.optim.Optimizer,
    ...
    model.train()
    metric_logger = cbm_utils.MetricLogger(delimiter="  ")
    metric_logger.add_meter('lr', cbm_utils.SmoothedValue(window_size=1, fmt='{value:.6f}'))
    metric_logger.add_meter('min_lr', cbm_utils.SmoothedValue(window_size=1, fmt='{value:.6f}'))

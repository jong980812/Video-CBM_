...
def bar(contributions, feature_names, max_display=10, show=True, title=None, fontsize=13, pos_color=(1, 0, 0)):  # default pos_color is red (1,0,0)
    ...
    for j in range(len(y_pos)):
        ...
        if values[ind] < 0:
            pl.text(
                ...
                horizontalalignment='right', verticalalignment='center', color=comp_color,
                fontsize=fontsize
            )
        else:
            pl.text(
